...
add_custom_target(final_rover_generate_messages ALL)
...
_generate_module_cpp(final_rover
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/final_rover
  "${ALL_GEN_OUTPUT_FILES_cpp}"
)

add_custom_target(final_rover_generate_messages_cpp
  DEPENDS ${ALL_GEN_OUTPUT_FILES_cpp}
)
add_dependencies(final_rover_generate_messages final_rover_generate_messages_cpp)
...
add_dependencies(final_rover_gencpp final_rover_generate_messages_cpp)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS final_rover_generate_messages_cpp)
...
### Generating Module File
_generate_module_eus(final_rover
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/final_rover
  "${ALL_GEN_OUTPUT_FILES_eus}"
)

add_custom_target(final_rover_generate_messages_eus
  DEPENDS ${ALL_GEN_OUTPUT_FILES_eus}
)
add_dependencies(final_rover_generate_messages final_rover_generate_messages_eus)
...
add_dependencies(final_rover_geneus final_rover_generate_messages_eus)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS final_rover_generate_messages_eus)
...
### Generating Module File
_generate_module_lisp(final_rover
  ${CATKIN_DEVEL_PREFIX}/${genlisp_INSTALL_DIR}/final_rover
  "${ALL_GEN_OUTPUT_FILES_lisp}"
)

add_custom_target(final_rover_generate_messages_lisp
  DEPENDS ${ALL_GEN_OUTPUT_FILES_lisp}
)
add_dependencies(final_rover_generate_messages final_rover_generate_messages_lisp)
...
add_dependencies(final_rover_genlisp final_rover_generate_messages_lisp)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS final_rover_generate_messages_lisp)
...
### Generating Module File
_generate_module_nodejs(final_rover
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/final_rover
  "${ALL_GEN_OUTPUT_FILES_nodejs}"
)

add_custom_target(final_rover_generate_messages_nodejs
  DEPENDS ${ALL_GEN_OUTPUT_FILES_nodejs}
)
add_dependencies(final_rover_generate_messages final_rover_generate_messages_nodejs)
...
add_dependencies(final_rover_gennodejs final_rover_generate_messages_nodejs)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS final_rover_generate_messages_nodejs)
...
### Generating Module File
_generate_module_py(final_rover
  ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/final_rover
  "${ALL_GEN_OUTPUT_FILES_py}"
)

add_custom_target(final_rover_generate_messages_py
  DEPENDS ${ALL_GEN_OUTPUT_FILES_py}
)
add_dependencies(final_rover_generate_messages final_rover_generate_messages_py)
...
# target for backward compatibility
add_custom_target(final_rover_genpy)
add_dependencies(final_rover_genpy final_rover_generate_messages_py)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS final_rover_generate_messages_py)



if(gencpp_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/final_rover)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/final_rover
    DESTINATION ${gencpp_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_cpp)
  add_dependencies(final_rover_generate_messages_cpp std_msgs_generate_messages_cpp)
endif()

if(geneus_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/final_rover)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/final_rover
    DESTINATION ${geneus_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_eus)
  add_dependencies(final_rover_generate_messages_eus std_msgs_generate_messages_eus)
endif()

if(genlisp_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genlisp_INSTALL_DIR}/final_rover)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${genlisp_INSTALL_DIR}/final_rover
    DESTINATION ${genlisp_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_lisp)
  add_dependencies(final_rover_generate_messages_lisp std_msgs_generate_messages_lisp)
endif()

if(gennodejs_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/final_rover)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/final_rover
    DESTINATION ${gennodejs_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_nodejs)
  add_dependencies(final_rover_generate_messages_nodejs std_msgs_generate_messages_nodejs)
endif()

if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/final_rover)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/final_rover\")")
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/final_rover
    DESTINATION ${genpy_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_py)
  add_dependencies(final_rover_generate_messages_py std_msgs_generate_messages_py)
endif()
